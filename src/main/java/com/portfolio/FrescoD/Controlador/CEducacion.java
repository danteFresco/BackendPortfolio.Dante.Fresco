...
import com.portfolio.FrescoD.Dto.dtoEducacion;
import com.portfolio.FrescoD.Security.Controller.Mensaje;
import com.portfolio.FrescoD.Servicio.SEducacion;
import com.portfolio.FrescoD.entidad.Educacion;
  ...
  @Autowired
    ...
    public ResponseEntity<?> create(@RequestBody dtoEducacion dtoeducacion){
        ...
        Educacion educacion = new Educacion(
                dtoeducacion.getNombreE(),dtoeducacion.getTituloE() , dtoeducacion.getDescripcionE(), dtoeducacion.getFechaE()
            );
